...
| figure | line | source | status |
|---|---|---|---|
| **"60% of tracks played exactly once"** | 628 | canonical 61.8%, raw 61.6% `[executed]` | **STALE** — README itself uses 61.8% at line 54; this line's "60%" is imprecise vs. the canonical 61.8% already used above |
| **"top 20 account for 9.6% of plays"** | 629 | canonical 11.7%, raw 9.0% `[executed]` | **STALE** — matches neither frame exactly |
...
| **PCA 20-d → 38 clusters, 15.6% largest** | 653 | `genre_coverage.md`, `backfill_plan.md:191`, `readme_audit.md:257` all say **37** real clusters on the current 2,918-canonical-track frame `[source-read]` | **STALE** — current cluster count is 37 |
