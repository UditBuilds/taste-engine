...
## 4. Cluster-count drift (resolved)
An earlier version of this report found 8 qualifying clusters where reports/dormancy_signals.md found 10, and treated the difference as drift between two measurement days. The difference came from the two reports using different anchors. With both anchored to MAX(watched_at), both find 10. See reports/gate_drift_audit.md, Resolution.
